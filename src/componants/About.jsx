        ...
        <AbsoluteWrapper>
            <div className="aboutContainer">
                <animated.div style={enter} className="aboutContent">
                    ...
                    <h1>About Me</h1>
                    <animated.p style={fade1}>Hello, my name is Anthony McGreal. Im a junior developer based in Bolton,Manchester. After spending 15 years in the hospitality sector and seeing the vulnerability of workers in that industry exposed during the Covid lockdowns I decided to turn my curiosity of coding into a fully fledged life goal. I was going to learn to code and pursue it as a profession.</animated.p>
